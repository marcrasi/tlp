...
Elm.MouseEvents = Elm.MouseEvents || {};
Elm.MouseEvents.make = function (_elm) {
   "use strict";
   _elm.MouseEvents = _elm.MouseEvents || {};
   if (_elm.MouseEvents.values) return _elm.MouseEvents.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Json$Decode = Elm.Json.Decode.make(_elm),
   ...
   var on = F2(function (name,message) {    return A3($VirtualDom.on,name,positionDecoder,message);});
   ...
   return _elm.MouseEvents.values = {_op: _op
                                    ,onClick: onClick
...
Elm.Main.make = function (_elm) {
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $MouseEvents = Elm.MouseEvents.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Svg = Elm.Svg.make(_elm),
   $Svg$Attributes = Elm.Svg.Attributes.make(_elm);
   var _op = {};
   var mb = $Signal.mailbox({ctor: "_Tuple2",_0: 0,_1: 0});
   var listener = $MouseEvents.onMouseOut($Signal.message(mb.address));
   var view = function (value) {
      return A2($Svg.svg,
      _U.list([$Svg$Attributes.width("120"),$Svg$Attributes.height("120"),$Svg$Attributes.viewBox("0 0 120 120")]),
      _U.list([A2($Svg.rect,
      _U.list([$Svg$Attributes.x("10")
              ,$Svg$Attributes.y("10")
   ...
   var debugView = function (value) {    return view(A2($Debug.log,"click value",value));};
   var main = A2($Signal.map,debugView,mb.signal);
   return _elm.Main.values = {_op: _op,mb: mb,listener: listener,view: view,debugView: debugView,main: main};
};
